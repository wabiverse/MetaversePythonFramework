...
# - xrOS            - build everything for visionOS
...
# macOS:
#     https://github.com/wabiverse/MetaverseCPythonMacOSFramework/releases
# xrOS, iOS, tvOS, watchOS:
#     https://github.com/wabiverse/MetaverseCPythonFramework/releases
...
# Supported OS
OS_LIST=macOS xrOS iOS tvOS watchOS
...
CFLAGS-xrOS=-mios-version-min=$(VERSION_MIN-xrOS)
...
downloads/bzip2-$(BZIP2_VERSION)-$(target).tar.gz:
	...
	mkdir -p downloads
	curl $(CURL_FLAGS) -o $$@ \
		https://github.com/wabiverse/MetaverseCPythonFramework/releases/download/BZip2-$(BZIP2_VERSION)/bzip2-$(BZIP2_VERSION)-$(target).tar.gz
...
downloads/xz-$(XZ_VERSION)-$(target).tar.gz:
	...
	mkdir -p downloads
	curl $(CURL_FLAGS) -o $$@ \
		https://github.com/wabiverse/MetaverseCPythonFramework/releases/download/XZ-$(XZ_VERSION)/xz-$(XZ_VERSION)-$(target).tar.gz
...
downloads/openssl-$(OPENSSL_VERSION)-$(target).tar.gz:
	...
	mkdir -p downloads
	curl $(CURL_FLAGS) -o $$@ \
		https://github.com/wabiverse/MetaverseCPythonFramework/releases/download/OpenSSL-$(OPENSSL_VERSION)/openssl-$(OPENSSL_VERSION)-$(target).tar.gz
...
downloads/libffi-$(LIBFFI_VERSION)-$(target).tar.gz:
	...
	mkdir -p downloads
	curl $(CURL_FLAGS) -o $$@ \
		https://github.com/wabiverse/MetaverseCPythonFramework/releases/download/libFFI-$(LIBFFI_VERSION)/libffi-$(LIBFFI_VERSION)-$(target).tar.gz
...
downloads/bzip2-$(BZIP2_VERSION)-$(sdk).tar.gz:
	...
	mkdir -p downloads
	curl $(CURL_FLAGS) -o $$@ \
		https://github.com/wabiverse/MetaverseCPythonMacOSFramework/releases/download/BZip2-$(BZIP2_VERSION)/bzip2-$(BZIP2_VERSION)-$(sdk).tar.gz
...
downloads/xz-$(XZ_VERSION)-$(sdk).tar.gz:
	...
	mkdir -p downloads
	curl $(CURL_FLAGS) -o $$@ \
		https://github.com/wabiverse/MetaverseCPythonMacOSFramework/releases/download/XZ-$(XZ_VERSION)/xz-$(XZ_VERSION)-$(sdk).tar.gz
...
downloads/openssl-$(OPENSSL_VERSION)-$(sdk).tar.gz:
	...
	mkdir -p downloads
	curl $(CURL_FLAGS) -o $$@ \
		https://github.com/wabiverse/MetaverseCPythonMacOSFramework/releases/download/OpenSSL-$(OPENSSL_VERSION)/openssl-$(OPENSSL_VERSION)-$(sdk).tar.gz
